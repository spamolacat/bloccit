  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved wiki as @wiki" do
        ...
        post :create, {:wiki => { "content" => "invalid value" }}, valid_session
        assigns(:wiki).should be_a_new(Wiki)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested wiki" do
        ...
        Wiki.any_instance.should_receive(:update_attributes).with({ "content" => "MyString" })
        put :update, {:id => wiki.to_param, :wiki => { "content" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the wiki as @wiki" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Wiki.any_instance.stub(:save).and_return(false)
        put :update, {:id => wiki.to_param, :wiki => { "content" => "invalid value" }}, valid_session
        assigns(:wiki).should eq(wiki)
      end
